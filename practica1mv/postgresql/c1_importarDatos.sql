...
copy Oferta (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, TIPO_CENTRO, TIPO_ESTUDIO,
	...
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Oferta2019.csv'
	delimiter ';' csv header;

copy Oferta (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, TIPO_CENTRO, TIPO_ESTUDIO,
	PLAZAS_OFERTADAS, PLAZAS_MATRICULADAS, PLAZAS_SOLICITADAS, INDICE_OCUPACION,
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Oferta2020.csv'
	delimiter ';' csv header;

copy Oferta (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, TIPO_CENTRO, TIPO_ESTUDIO,
	PLAZAS_OFERTADAS, PLAZAS_MATRICULADAS, PLAZAS_SOLICITADAS, INDICE_OCUPACION,
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Oferta2021.csv'
	delimiter ';' csv header;
...
copy Resultados (CURSO_ACADEMICO, CENTRO, ESTUDIO, TIPO_ESTUDIO, ALUMNOS_MATRICULADOS,
	...
	CREDITOS_MATRICULADOS, CREDITOS_RECONOCIDOS, DURACION_MEDIA_GRADUADOS, TASA_EXITO,
	TASA_RENDIMIENTO, TASA_EFICIENCIA, TASA_ABANDONO, TASA_GRADUACION, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Resultados2020.csv' 
	delimiter ';' csv header;
...
copy Resultados (CURSO_ACADEMICO, CENTRO, ESTUDIO, TIPO_ESTUDIO, ALUMNOS_MATRICULADOS,
	...
	from '/home/alumno/practica1/postgresql/Datos/Resultados2021.csv' 
	delimiter ';' csv header;
...
copy Notas (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, PRELA_CONVO_NOTA_DEF,
	...
	from '/home/alumno/practica1/postgresql/Datos/Notas2019.csv'
	delimiter ';' csv header;

copy Notas (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, PRELA_CONVO_NOTA_DEF,
	NOTA_CORTE_DEFINITIVA_JULIO, NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Notas2020.csv'
	delimiter ';' csv header;

copy Notas (CURSO_ACADEMICO, ESTUDIO, LOCALIDAD, CENTRO, PRELA_CONVO_NOTA_DEF,
	NOTA_CORTE_DEFINITIVA_JULIO, NOTA_CORTE_DEFINITIVA_SEPTIEMBRE, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Notas2021.csv'
	delimiter ';' csv header;
...
copy Movilidad (CURSO_ACADEMICO, NOMBRE_PROGRAMA_MOVILIDAD, NOMBRE_AREA_ESTUDIOS_MOV, CENTRO,
	...
	from '/home/alumno/practica1/postgresql/Datos/Movilidad2019.csv' 
	delimiter ';' csv header;

copy Movilidad (CURSO_ACADEMICO, NOMBRE_PROGRAMA_MOVILIDAD, NOMBRE_AREA_ESTUDIOS_MOV, CENTRO,
	IN_OUT, NOMBRE_IDIOMA_NIVEL_MOVILIDAD, PAIS_UNIVERSIDAD_ACUERDO, UNIVERSIDAD_ACUERDO,
	PLAZAS_OFERTADAS_ALUMNOS, PLAZAS_ASIGNADAS_ALUMNOS_OUT, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Movilidad2020.csv' 
	delimiter ';' csv header;

copy Movilidad (CURSO_ACADEMICO, NOMBRE_PROGRAMA_MOVILIDAD, NOMBRE_AREA_ESTUDIOS_MOV, CENTRO,
	IN_OUT, NOMBRE_IDIOMA_NIVEL_MOVILIDAD, PAIS_UNIVERSIDAD_ACUERDO, UNIVERSIDAD_ACUERDO,
	PLAZAS_OFERTADAS_ALUMNOS, PLAZAS_ASIGNADAS_ALUMNOS_OUT, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Movilidad2021.csv' 
	delimiter ';' csv header;
...
copy Egresados (CURSO_ACADEMICO, LOCALIDAD, ESTUDIO, TIPO_ESTUDIO, TIPO_EGRESO, SEXO,
	...
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Egresados2019.csv' 
	delimiter ';' csv header;
...
copy Egresados (CURSO_ACADEMICO, LOCALIDAD, ESTUDIO, TIPO_ESTUDIO, TIPO_EGRESO, SEXO,
	...
	ALUMNOS_TRASLADAN_OTRA_UNIV, DURACION_MEDIA_GRADUADOS, TASA_EFICIENCIA,
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Egresados2020.csv' 
	delimiter ';' csv header;
...
copy Egresados (CURSO_ACADEMICO, LOCALIDAD, ESTUDIO, TIPO_ESTUDIO, TIPO_EGRESO, SEXO,
	...
	ALUMNOS_TRASLADAN_OTRA_UNIV, DURACION_MEDIA_GRADUADOS, TASA_EFICIENCIA,
	FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Egresados2021.csv' 
	delimiter ';' csv header;
...
copy Rendimiento (CURSO_ACADEMICO, TIPO_ESTUDIO, ESTUDIO, LOCALIDAD, CENTRO, ASIGNATURA,
	...
	from '/home/alumno/practica1/postgresql/Datos/Rendimiento2019.csv' 
	delimiter ';' csv header;
...
copy Rendimiento (CURSO_ACADEMICO, TIPO_ESTUDIO, ESTUDIO, LOCALIDAD, CENTRO, ASIGNATURA,
	...
	ALUMNOS_EVALUADOS, ALUMNOS_SUPERADOS, ALUMNOS_PRESENTADOS,
	MEDIA_CONVOCATORIAS_CONSUMIDAS, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Rendimiento2020.csv'
	delimiter ';' csv header;
...
copy Rendimiento (CURSO_ACADEMICO, TIPO_ESTUDIO, ESTUDIO, LOCALIDAD, CENTRO, ASIGNATURA,
	...
	ALUMNOS_EVALUADOS, ALUMNOS_SUPERADOS, ALUMNOS_PRESENTADOS,
	MEDIA_CONVOCATORIAS_CONSUMIDAS, FECHA_ACTUALIZACION) 
	from '/home/alumno/practica1/postgresql/Datos/Rendimiento2021.csv' 
	delimiter ';' csv header;
